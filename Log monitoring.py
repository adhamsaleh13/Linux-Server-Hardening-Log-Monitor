...
Email_sender = "enter_the_email_sender_here@gmail.com"
Email_password = "enter_the_app_password_here"  # App password from Google account settings
Email_receiver = "enter_the_email_receiver_here@gmail.com"
